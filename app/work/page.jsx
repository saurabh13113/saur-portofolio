...
const projects = [
    ...
    {num: '04', category: 'FullStack', title:'UAE Metro Ticketer',description:'Highschool Project that allows customers to purchase UAE metro tickets',
    ...
    {num: '05', category: 'FullStack', title:'Pantry Tracker',description:'Summer Project that is a pantry management application built with Next.js, Material UI, and Firebase',
    ...
    {num: '06', category: 'Backend', title:'Huffman Tree File Compressor',description:'University project that decompresses file sizes using Huffman trees.',
    ...
    {num: '07', category: 'Frontend', title:'Mobile System Tracker',description:'University assignment to track a mobile company and its customers including a visualizer to do the same',
    ...
    {num: '08', category: 'FullStack', title:'TreeMap File Organizer',description:'University project that makes use of file system trees and treemaps to organize files and folders using a visualizer.',
    ...
    {num: '09', category: 'Frontend', title:'Driver Rider Pairer',description:'University project that matches up drivers and riders based on locational information',
    ...
    {num: '10', category: 'FullStack', title:'MindSnatcher Player Game',description:'University assignment to build a game over three months using Java and JavaFX following the principle of Agile Software development in a team of 4.',
    ...
    {num: '11', category: 'Backend', title:'Add Echo Program',description:'University project that removes vocals and adds an echoing sound to a audio(wav) file by decoding bit information.',
    ...
    {num: '12', category: 'Backend', title:'tsh Mini Shell',description:'University project making a replica mini shell command prompt using C',
    ...
    {num: '13', category: 'Backend', title:'Multiplayer Server Game',description:'University project that creates a local server on the Uoft servers and allows users to join and play a simple battle game',
